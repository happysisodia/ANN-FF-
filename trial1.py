...
class NeuralNetwork():
    ...
    def evaluate(self,X,y):
        ...
        #loss_error = self.cross_entropy(pred, y)
...
if __name__ == '__main__':
    ...
    Acccuracy = 0
    NN = NeuralNetwork()
    s = Smote(sample=data_AEP, N=3000, k=5)
    s.over_sampling()
    aep = np.array(s.synthetic)
